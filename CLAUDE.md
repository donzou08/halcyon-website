...
Figures verified 4 Aug 2026, against the databases as they stood then:
...
- **Quotation:** ₹47.54 crore total quoted, 36 quotations, ₹1.32 cr average, ₹23.03 cr largest, ₹3,640 smallest, 15 companies, 18 sites, 74 line items, 20 system configurations, 4 brands, 3 divisions, 37 site price overrides, live since 1 Jul 2026. The earlier "40+ products across 8 application categories" was **not supported** (catalogue holds 7 systems / 4 brands / 3 divisions) and has been replaced.
